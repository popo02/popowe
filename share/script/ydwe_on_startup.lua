...
local function initialize_reg()
	...
	reg["TC_COMMENT"] = { registry.REG_DWORD, 0xffc000c0 }
	reg["PO_Leak"] = { registry.REG_DWORD, 0xffff0000 }
	reg["PO_CheckSync"] = { registry.REG_DWORD, 0xffff0000 }
	reg["PO_Clear"] = { registry.REG_DWORD, 0xffff0000 }
	reg["PO_Command"] = { registry.REG_DWORD, 0xffff0000 }
	reg["Online"] = { registry.REG_DWORD, 0xffff0000 }
end
...
function event.EVENT_WE_START(event_data)
	...
	-- 虚拟MPQ
	virtual_mpq.open_path(fs.war3_path() / "Custom_V1", 14)
