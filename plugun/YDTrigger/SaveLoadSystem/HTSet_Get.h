...
#  define YDTRIGGER_IntGroup(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_EffectId(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_EctGroup(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_ItemGroup(SG)                       YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_SortGroup(SG)                       YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_PO_Sound(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_PO_Music(SG)                        YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_AuMagicId(SG)                        YDTRIGGER_HT##SG##(Integer)
#                                                  
#endif
