...
#  define YDTRIGGER_HC_frame(HC)                            YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_IntGroup(HC)                         YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_EffectId(HC)                         YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_EctGroup(HC)                         YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_ItemGroup(HC)                        YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_SortGroup(HC)                        YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_PO_Sound(HC)                         YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_PO_Music(HC)                         YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_AuMagicId(HC)                         YDTRIGGER_##HC##(Integer)
#
#
#endif
