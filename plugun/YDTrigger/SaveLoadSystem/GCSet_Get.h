...
#  define YDTRIGGER_SET_frame                           YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_IntGroup                        YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_EffectId                        YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_EctGroup                        YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_ItemGroup                       YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_SortGroup                       YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_PO_Sound                        YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_PO_Music                        YDTRIGGER_GCSET_INTEGER
#  define YDTRIGGER_SET_AuMagicId                       YDTRIGGER_GCSET_INTEGER
#
