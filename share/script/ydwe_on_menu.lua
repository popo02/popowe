...
-- 显示版本信息
local function show_popo_version()
	os.execute('explorer "jass\\popo\\explain.chm"')
end
...
function event.EVENT_INIT_MENU(event_data)
	...
	local menu3 = gui.menu(event_data.main_menu_handle, _("版本信息"))
	menu3:add(_("版本信息"), show_popo_version)
