...
MoveType[9] = 0x80; // 两栖
    ...
    public {
        ...
        function PO_Inverse36System (string s) -> integer {
            ...
            for (0 < i <= i1) {
                a = LoadInteger(ht, <?= StringHash("36进制") ?>, StringHash(SubStringBJ(s, i, i)));
        ...
        function PO_Inverse62System (string s) -> integer {
            ...
            for (0 < i <= i1) {
                a = LoadInteger(ht, <?= StringHash("62进制") ?>, StringHash(SubStringBJ(s, i, i)));
        ...
        function PO_TriggerRegisterEnterRectSimple (trigger trig, rect r) -> event {
            ...
            SaveRectHandle(ht, GetHandleId(rectRegion), <?= StringHash("矩形区域") ?>, r);
        ...
        function PO_GetTriggeringRect () -> rect {
            return LoadRectHandle(ht, GetHandleId(GetTriggeringRegion()), <?= StringHash("矩形区域") ?>);
        }
        //  判断坐标是否可通过
        ...
        function PO_Repel(unit u, real deg, real spd, real dis, real s) -> nothing {
            ...
            if (HaveSavedHandle(ht, GetHandleId(u), <?= StringHash("击退计时器") ?>)) {
                t = LoadTimerHandle(ht, GetHandleId(u), <?= StringHash("击退计时器") ?>);
            } else {
                t = CreateTimer();
                SaveTimerHandle(ht, GetHandleId(u), <?= StringHash("击退计时器") ?>, t);
                switch = true;
            }
            hand = GetHandleId(t);
            SaveUnitHandle(ht, hand, <?= StringHash("u") ?>, u);
            SaveReal(ht, hand, <?= StringHash("deg") ?>, deg);
            SaveReal(ht, hand, <?= StringHash("spd") ?>, spd);
            SaveReal(ht, hand, <?= StringHash("dis") ?>, dis);
            SaveReal(ht, hand, <?= StringHash("jl") ?>, 0);
            SaveBoolean(POHT, GetHandleId(u), <?= StringHash("击退状态") ?>, true);
            if (switch) {
                TimerStart(t, s, true, function(){
                    timer t = GetExpiredTimer();
                    integer hand = GetHandleId(t);
                    unit u = LoadUnitHandle(ht, hand, <?= StringHash("u") ?>);
                    real deg = LoadReal(ht, hand, <?= StringHash("deg") ?>);
                    real spd = LoadReal(ht, hand, <?= StringHash("spd") ?>);
                    real dis = LoadReal(ht, hand, <?= StringHash("dis") ?>);
                    real jl = LoadReal(ht, hand, <?= StringHash("jl") ?>);
                    boolean condition = LoadBoolean(POHT, GetHandleId(u), <?= StringHash("击退状态") ?>);
                    real x = GetUnitX(u);
                    real y = GetUnitY(u);
                    
                    jl += spd;
                    SaveReal(ht, hand, <?= StringHash("jl") ?>, jl);
                    ...
                    if (jl >= dis || !condition) {
                        SaveBoolean(POHT, GetHandleId(u), <?= StringHash("击退状态") ?>, false);
                        RemoveSavedHandle(ht, GetHandleId(u), <?= StringHash("击退计时器") ?>);
        ...
        function PO_Jump(unit u, real heighMax, real s) {
            ...
            boolean switch = false;
            if (HaveSavedHandle(ht, GetHandleId(u), <?= StringHash("击飞计时器") ?>)) {
                t = LoadTimerHandle(ht, GetHandleId(u), <?= StringHash("击飞计时器") ?>);
                
            } else {
                t = CreateTimer();
                SaveTimerHandle(ht, GetHandleId(u), <?= StringHash("击飞计时器") ?>, t);
                switch = true;
            }
            hand = GetHandleId(t);
            SaveUnitHandle(ht, hand, <?= StringHash("u") ?>, u);
            SaveReal(ht, hand, <?= StringHash("steeps") ?>, 0.0);
            SaveReal(ht, hand, <?= StringHash("dheig") ?>, dheig);
            SaveReal(ht, hand, <?= StringHash("heighMax") ?>, heighMax);
            SaveReal(ht, hand, <?= StringHash("height1") ?>, 0.0);
            ...
            if (switch) {
                TimerStart(t, 0.01, true, function(){
                    ...
                    integer hand = GetHandleId(t);
                    unit u = LoadUnitHandle(ht, hand, <?= StringHash("u") ?>);
                    real dheig = LoadReal(ht, hand, <?= StringHash("dheig") ?>);
                    real heighMax = LoadReal(ht, hand, <?= StringHash("heighMax") ?>);
                    real height1 = LoadReal(ht, hand, <?= StringHash("height1") ?>);
                    real steeps = LoadReal(ht, hand, <?= StringHash("steeps") ?>) + 1.0;
                    real height = (0.0 - ( 2.0 * steeps * dheig - 1.0 ) * ( 2.0 * steeps * dheig - 1.0 ) + 1.0 ) * heighMax;
                    real height2 = height - height1;
                    height1 += height2;
                    SaveReal(ht, hand, <?= StringHash("steeps") ?>, steeps);
                    SaveReal(ht, hand, <?= StringHash("height1") ?>, height1);
                    SetUnitFlyHeight(u, GetUnitFlyHeight(u) + height2, 0.0);
                    if (R2I(GetUnitFlyHeight(u)) <= 0) {
                        SetUnitFlyHeight(u, 0.0, 0.0);
                        RemoveSavedHandle(ht, GetHandleId(u), <?= StringHash("击飞计时器") ?>);
                        FlushChildHashtable(ht, hand);
                        DestroyTimer(t);
                    }
                    t = null;
        ...
        function PO_JumpMove(unit u, real deg, real dis, real high, real time) {
            ...
            integer hand;
            boolean switch = false;
            if (HaveSavedHandle(ht, GetHandleId(u), <?= StringHash("抛物线计时器") ?>)) {
                t = LoadTimerHandle(ht, GetHandleId(u), <?= StringHash("抛物线计时器") ?>);
            } else {
                t = CreateTimer();
                SaveTimerHandle(ht, GetHandleId(u), <?= StringHash("抛物线计时器") ?>, t);
                switch = true;
            }
            hand = GetHandleId(t);
            SaveUnitHandle(ht, hand, <?= StringHash("u") ?>, u);
            SaveReal(ht, hand, <?= StringHash("deg") ?>, deg);
            SaveReal(ht, hand, <?= StringHash("dis") ?>, dis);
            SaveReal(ht, hand, <?= StringHash("high") ?>, high);
            SaveReal(ht, hand, <?= StringHash("time") ?>, time);
            SaveReal(ht, hand, <?= StringHash("s") ?>, 0);
            UnitAddAbility(u, 'Amrf');
            UnitRemoveAbility(u, 'Amrf');
            SetUnitFlyHeight(u, 0.0, 0.0);
            if (switch) {
                TimerStart(t, 0.01, true, function(){
                    ...
                    real deg = LoadReal(ht, hand, <?= StringHash("deg") ?>);
                    real dis = LoadReal(ht, hand, <?= StringHash("dis") ?>);
                    real high = LoadReal(ht, hand, <?= StringHash("high") ?>);
                    real time = LoadReal(ht, hand, <?= StringHash("time") ?>);
                    real s = LoadReal(ht, hand, <?= StringHash("s") ?>) + 0.01;
                    real p = 1.0 / time;
                    real h = SinBJ(180.00 * s * p) * high;
                    real x = GetUnitX(u);
                    real y = GetUnitY(u);
                    real spd = dis / (time * 100);
                    SaveReal(ht, hand, <?= StringHash("s") ?>, s);
                    ...
                    if (s >= time) {
                        SetUnitFlyHeight(u, 0.0, 0.0);
                        RemoveSavedHandle(ht, GetHandleId(u), <?= StringHash("抛物线计时器") ?>);
                        FlushChildHashtable(ht, hand);
                        DestroyTimer(t);
                    }
                    t = null;
        ...
        function PO_MoveD(unit u, real x, real y, real spd, real dis, real s, boolean Swh, string model) -> nothing {
            ...
            integer hand, index;
            boolean switch = false;
            if (HaveSavedHandle(ht, GetHandleId(u), <?= StringHash("D闪") ?>)) {
                t = LoadTimerHandle(ht, GetHandleId(u), <?= StringHash("D闪") ?>);
            } else {
                t = CreateTimer();
                SaveTimerHandle(ht, GetHandleId(u), <?= StringHash("D闪") ?>, t);
                switch = true;
            }
            ...
            hand = GetHandleId(t);
            SaveUnitHandle(ht, hand, <?= StringHash("u") ?>, u);
            SaveReal(ht, hand, <?= StringHash("deg") ?>, PO_DegXY(GetUnitX(u), GetUnitY(u), x, y));
            SaveReal(ht, hand, <?= StringHash("spd") ?>, spd);
            SaveReal(ht, hand, <?= StringHash("dis") ?>, RMinBJ(PO_DisXY(GetUnitX(u), GetUnitY(u), x, y), dis));
            SaveReal(ht, hand, <?= StringHash("jl") ?>, 0);
            if (switch) {
                TimerStart(t, s, true, function(){
                    timer t = GetExpiredTimer();
                    ...
                    if (jl >= dis) {
                        ...
                        RemoveSavedHandle(ht, GetHandleId(u), <?= StringHash("D闪") ?>);
                        FlushChildHashtable(ht, hand);
                        DestroyTimer(t);
                    }
                    t = null;
                ...
                if (Swh) {
                    ...
                    SaveReal(ht, hand, <?= StringHash("spd") ?>, spd);
                    SaveReal(ht, hand, <?= StringHash("dis") ?>, RMinBJ(PO_DisXY(GetUnitX(u), GetUnitY(u), x, y), dis));
                    SaveReal(ht, hand, <?= StringHash("x") ?>, GetUnitX(u));
                    SaveReal(ht, hand, <?= StringHash("y") ?>, GetUnitY(u));
                    SaveReal(ht, hand, <?= StringHash("s") ?>, s);
                    SaveStr(ht, hand, <?= StringHash("model") ?>, model);
                    TimerStart(t, 0.05, true, function(){
                        ...
                        real spd = LoadReal(ht, hand, <?= StringHash("spd") ?>);
                        real dis = LoadReal(ht, hand, <?= StringHash("dis") ?>);
                        real x = LoadReal(ht, hand, <?= StringHash("x") ?>);
                        real y = LoadReal(ht, hand, <?= StringHash("y") ?>);
                        string model = LoadStr(ht, hand, <?= StringHash("model") ?>);
                        effect e = AddSpecialEffect(model, x, y);
                        real s = LoadReal(ht, hand, <?= StringHash("s") ?>);
                        real i = LoadReal(ht, hand, <?= StringHash("i") ?>) + 1.0;
                        timer m = CreateTimer();
                        integer hand2;
                        PO_Color(e, 0, 0, 0, i * 20);
                        EXEffectMatRotateZ(e, deg);
                        SaveReal(ht, hand, <?= StringHash("i") ?>, i);
                        
                        hand2 = GetHandleId(m);
                        SaveEffectHandle(ht, hand2, <?= StringHash("e") ?>, e);
                        SaveReal(ht, hand2, <?= StringHash("deg") ?>, deg);
                        SaveReal(ht, hand2, <?= StringHash("spd") ?>, spd);
                        SaveReal(ht, hand2, <?= StringHash("dis") ?>, dis);
                        TimerStart(m, s, true, function(){
                            timer t = GetExpiredTimer();
                            integer hand = GetHandleId(t);
                            effect e = LoadEffectHandle(ht, hand, <?= StringHash("e") ?>);
                            real deg = LoadReal(ht, hand, <?= StringHash("deg") ?>);
                            real spd = LoadReal(ht, hand, <?= StringHash("spd") ?>);
                            real dis = LoadReal(ht, hand, <?= StringHash("dis") ?>);
        ...
        function PO_ItemMouse() ->item {
            FlushChildHashtable(ht, <?= StringHash("mouseitem") ?>);
            SaveFogStateHandle(ht, <?= StringHash("mouseitem") ?>, 1, ConvertFogState(GetHandleId(DzGetUnitUnderMouse())));
            return LoadItemHandle(ht, <?= StringHash("mouseitem") ?>, 1);
        }
        // 获取矩形随机X坐标
