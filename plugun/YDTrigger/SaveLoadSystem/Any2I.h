...
#  define YDTRIGGER_ANY2I_frame(any)					    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_IntGroup(any)					    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_EffectId(any)					    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_EctGroup(any)					    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_ItemGroup(any)					YDHashI2I(any)
#  define YDTRIGGER_ANY2I_SortGroup(any)					YDHashI2I(any)
#  define YDTRIGGER_ANY2I_PO_Sound(any)			     		YDHashI2I(any)
#  define YDTRIGGER_ANY2I_PO_Music(any)					    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_AuMagicId(any)					YDHashI2I(any)
#
#
#endif
