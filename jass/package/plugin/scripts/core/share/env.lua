...
-- 注册jass
mt['jass'] = setmetatable({}, {__index = function(self, name)
    local func = jass[name]
    if func then 
        rawset(self, name, jass[name])
        return func
    end 
end,
})
...
-- 注册japi
mt['japi'] = setmetatable({}, {__index = function(self, name)
    local func = japi[name]
    if func then 
...
mt.japi['GetTargetObject'] = japi['DzGetUnitUnderMouse']
mt.japi['GetMouseX'] = japi['DzGetMouseTerrainX']   
mt.japi['GetMouseY'] = japi['DzGetMouseTerrainY']   
mt.japi['GetMouseZ'] = japi['DzGetMouseTerrainZ']   
