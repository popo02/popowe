...
#define YDUserPlayerDataClearTable(Player, table_type, table) YDHashClearTable(YDHASH_PLAYER_HANDLE(Player), YDHashAny2I(table_type, table))
#define YDUserPlayerDataClear(Player, table_type, table, attribute, value_type) YDHashClear(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>)
#define YDUserPlayerDataSet(Player, table_type, table, attribute, value_type, value) YDHashSet(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>, value)
#define YDUserPlayerDataGet(Player, table_type, table, attribute, value_type) YDHashGet(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>)
#define YDUserPlayerDataHas(Player, table_type, table, attribute, value_type) YDHashHas(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>)
#define YDUserPlayerDataSetop(Player, table_type, table, attribute, value_type, op, value) YDHashSet(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>, (YDHashGet(YDHASH_PLAYER_HANDLE(Player), value_type, YDHashAny2I(table_type, table), <?=StringHash(attribute)?>))op(value))
#
...
#define YDLocal7Setop(page, type, name, op, value)             YDHashSet(YDLOC, type, page, <?=StringHash(name)?>, (YDHashGet(YDLOC, type, page, <?=StringHash(name)?>))op(value))
#define YDLocal7ArraySetop(page, type, name, index, op, value) YDHashSet(YDLOC, type, page, <?=StringHash(name)?> + (index), (YDHashGet(YDLOC, type, page, <?=StringHash(name)?> + (index)))op(value))
#define YDLocal7Clear(page, type, name)                  YDHashClear(YDLOC, type, page, <?=StringHash(name)?>)
#define YDLOCAL_7                                        <?=StringHash("T版JASS函数")?>
